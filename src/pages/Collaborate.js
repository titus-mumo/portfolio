...
export const Collaborate = () => {
  ...
  return (
        <div className="collaborations sm:w-sm">
            ...
            <p className="text-sm md:text-base m-2 dark:text-white">Interested in working together? Let&#39's talk:</p>
            ...
            </div>
            {
                ...
                <span className="relative inline-flex rounded-full h-3 w-3 bg-sky-500"></span>
                  ...
                  : (<button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send message</button>)
            }
