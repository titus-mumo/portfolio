...
export const Skills = () => {
    ...
    return (
        <div className="skills  bg-gray-200 dark:bg-gray-900 rounded-md p-1 md:p-2 flex flex-col justify-center content-center mb-5 sm:mb-10 md:mb-20 mx-1 md:mx-5">
